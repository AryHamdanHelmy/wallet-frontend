    ...
    <div className="rounded-xl border border-line bg-white p-5">
      ...
      <form onSubmit={handleSubmit} className="mt-4" noValidate>
        <div className="mb-3 flex flex-wrap gap-2">
          {QUICK_AMOUNTS.map((nominal) => (
            <button
              ...
              className="rounded-full border border-line px-3 py-1.5 text-sm text-textPrimary transition hover:border-primary hover:text-primary disabled:opacity-50"
            >
        ...
        <button
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-primary px-4 py-2.5 text-[15px] font-medium text-white transition hover:bg-primaryHover disabled:cursor-not-allowed disabled:bg-[#9ec3dd]"
        >
          {submitting && (
